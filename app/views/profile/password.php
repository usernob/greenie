    ...
    <div class="flex flex-col items-start gap-4 flex-1 p-4">
        <div class="flex flex-col w-full items-start gap-2">
            ...
            <div class="relative w-full">
                ...
                <input class="w-full col-span-3 py-2 px-4 rounded-md outline outline-1 outline-slate-700 bg-slate-100 focus:outline-2" id="password" name="old_pw" required type="password">
            </div>
        </div>
        <div class="flex flex-col w-full items-start gap-2">
            <label class="text-right my-auto font-medium">Password Baru</label>
            <input class="w-full col-span-3 py-2 px-4 rounded-md outline outline-1 outline-slate-700 bg-slate-100 focus:outline-2" id="new_pw" name="new_pw" required type="text">
        </div>
        <div class="flex flex-col w-full items-start gap-2">
            <label class="text-right my-auto font-medium">Konfirmasi Password</label>
            <input class="w-full col-span-3 py-2 px-4 rounded-md outline outline-1 outline-slate-700 bg-slate-100 focus:outline-2" id="confirm_pw" name="confirm_pw" required type="text">
