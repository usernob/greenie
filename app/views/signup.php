...
<body class="bg-main font-main">
    <div class="container">
        <form action="<?= BASE_URL ?>/signup/validate" method="post" class="sm:mx-20 md:mx-32 lg:mx-40 xl:mx-72 my-10 rounded-md shadow-2xl bg-slate-100">
            <div class="flex justify-center items-center flex-col gap-4 p-6">
                ...
                <label class="w-full">
                    ...
                    <input type="text" placeholder="Masukkan Username" name="username" id="username" class="w-full py-2 px-4 rounded-md outline outline-1 outline-slate-700 bg-slate-100 focus:outline-2" required>
                </label>
                <label class="w-full">
                ...
                <label class="w-full">
                    ...
                    <input type="tel" value="<?= isset($_SESSION['no_hp']) ? $_SESSION['no_hp'] : '' ?>" placeholder="Masukkan No Telepon" name="no_hp" id="no_hp" class="w-full py-2 px-4 rounded-md outline outline-1 outline-slate-700 bg-slate-100 focus:outline-2" required>
                </label>
