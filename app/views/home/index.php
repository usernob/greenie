        ...
        <div id="carouselExampleControls" class="carousel slide relative w-full max-h-80" data-bs-ride="carousel">
            <div class="carousel-inner relative w-full overflow-hidden">
                <div class="carousel-item active relative float-left w-full max-h-80">
                    <img src="<?= BASE_URL ?>/assets/dummy-image.jpg" class="block w-full h-80 object-cover object-center" alt="Wild Landscape" />
                </div>
                <div class="carousel-item relative float-left w-full max-h-80">
                    <img src="<?= BASE_URL ?>/assets/dummy-image.jpg" class="block w-full h-80 object-cover object-center" alt="Camera" />
                </div>
                <div class="carousel-item relative float-left w-full max-h-80">
                    <img src="<?= BASE_URL ?>/assets/dummy-image.jpg" class="block w-full h-80 object-cover object-center" alt="Exotic Fruits" />
                </div>
            </div>
